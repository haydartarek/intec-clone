...
window.i18n.nl = {
  ...
  "home.partnerCallout.title": "INOPTEC+: Uw betrouwbare partner voor naadloze IT-ondersteuning en snelle interventies.",
  ...
  "contact.hours.phone": "<strong>Telefonisch:</strong> 9:00 - 12:00, 13:00 - 16:00",
  ...
  "contact.location.address": "<strong>INTEC Brussel</strong><br />Rouppeplein 16<br />1000 Brussel",
  ...
  "contact.map.phone": "<strong>Telefoon:</strong><br /><a href=\"tel:+3224112907\">+32 2 411 29 07</a>",

  "contact.map.email": "<strong>E-mail:</strong><br /><a href=\"mailto:info@intecbrussel.be\">info@intecbrussel.be</a>",
  ...
  "support.dates.note": "<strong>Let op:</strong> Inschrijven voor een opleiding kan pas vanaf 6 maanden vóór de startdatum van de opleiding.<br />De inschrijving voor deze opleiding gebeurt via de opleiding ICT-supportmedewerker.",

  "support.dates.cta": "IK WIL DEZE OPLEIDING",

  "support.requirements.title": "Voorwaarden",

  "support.requirements.item1": "Je bent werkzoekend op de dag dat de opleiding start",
  ...
  "support.modules.module1.body": "In de eerste modules leer je de fundamenten van computerhardware en -software. Je wordt vertrouwd gemaakt met verschillende computercomponenten zoals processors, moederborden, opslagapparaten (HDD, SSD) en randapparatuur. Ook krijg je inzicht in de installatie en configuratie van besturingssystemen zoals Windows en Linux, evenals het gebruik en onderhoud van veelvoorkomende softwareprogramma’s.",

  "support.modules.module1.topic1": "<strong>Hardware-onderdelen en troubleshoot-technieken:</strong> Je leert hoe je computeronderdelen kunt identificeren, installeren en vervangen, en je traint troubleshooting voor veelvoorkomende hardwareproblemen.",

  "support.modules.module1.topic2": "<strong>Besturingssystemen:</strong> Installatie en configuratie van Windows- en Linux-besturingssystemen, inclusief virtuele machines en cloudgebaseerde oplossingen.",

  "support.modules.module2.title": "Netwerken en Beveiliging",

  "support.modules.module2.body": "Een belangrijk deel van de opleiding richt zich op netwerken en de basisprincipes van netwerkbeheer en beveiliging. Je leert hoe je netwerken opzet en beheert, en hoe je problemen met connectiviteit oplost.",

  "support.modules.module2.topic1": "<strong>Netwerkbeheer:</strong> Je krijgt een solide basis in het configureren en beheren van netwerken, inclusief draadloze netwerken, IP-adressering en netwerkapparatuur.",

  "support.modules.module2.topic2": "<strong>Beveiliging:</strong> Je wordt opgeleid in cybersecurityprincipes zoals het beveiligen van netwerkverbindingen, firewallconfiguraties en VPN-oplossingen. Dit omvat ook het detecteren en voorkomen van cyberdreigingen.",

  "support.modules.module3.title": "Virtualisatie en Cloudtechnologieën",

  "support.modules.module3.body": "De opkomst van cloudtechnologieën en virtualisatie biedt veel kansen in de IT-sector. In deze module leer je de basis van virtualisatie met platforms zoals Microsoft Hyper-V en VMware, evenals cloudoplossingen zoals Microsoft Azure en Google Cloud.",

  "support.modules.module3.topic1": "<strong>Virtualisatie:</strong> Je leert hoe je virtuele machines aanmaakt en beheert, en hoe je virtualisatie-infrastructuren configureert voor efficiënt netwerkgebruik.",

  "support.modules.module3.topic2": "<strong>Cloud computing:</strong> Ontdek hoe cloudgebaseerde diensten werken en leer de principes van cloudbeheer, waaronder het opzetten en beheren van cloudservers en dataopslag.",

  "support.modules.module4.title": "ITIL en Helpdeskvaardigheden",

  "support.modules.module4.body": "Een goede ICT-supportmedewerker is niet alleen technisch vaardig, maar ook sterk in klantenservice. In deze module leer je de belangrijkste principes van ITIL (IT Infrastructure Library) en helpdesksoftware, zodat je in staat bent om tickets correct te verwerken, klantproblemen efficiënt op te lossen, en hoogwaardige IT-diensten te verlenen.",

  "support.modules.module4.topic1": "<strong>Helpdesk en klantenservice:</strong> Je leert hoe je klanten professioneel te woord staat, hun problemen analyseert en oplost, en hoe je deze interacties documenteert.",

  "support.modules.module4.topic2": "<strong>ITIL-principes:</strong> Je leert hoe je incidenten, problemen en veranderingen in een IT-omgeving beheert volgens de ITIL-standaarden.",

  "support.modules.module5.title": "Geavanceerde Windows en Linux OS",

  "support.modules.module5.body": "In de gevorderde fase van de opleiding richt je je op het beheren van Windows- en Linux-omgevingen. Dit omvat het configureren en beheren van geavanceerde netwerkdiensten, zoals Active Directory, DNS, DHCP en serverbeheer in virtuele omgevingen.",

  "support.modules.module5.topic1": "<strong>Windows Server:</strong> Installatie, configuratie en beheer van Windows Servers, inclusief virtualisatie en netwerkdiensten zoals DNS, DHCP en Active Directory.",

  "support.modules.module5.topic2": "<strong>Linux-serverbeheer:</strong> Je leert werken met Linux-servers, van installatie en configuratie tot gebruikersbeheer en netwerkadministratie.",

  "support.modules.module6.title": "Certificering en Specialisatie",

  "support.modules.module6.body": "Tijdens de opleiding krijg je de mogelijkheid om deel te nemen aan certificeringsprogramma’s zoals Cisco Certified Support Technician en CompTIA A+. Deze internationaal erkende certificaten verhogen je inzetbaarheid op de arbeidsmarkt.",

  "support.modules.module6.topic1": "<strong>Certificeringen:</strong> Behaal waardevolle certificaten zoals Cisco en CompTIA, waarmee je je technische kennis kunt aantonen en je carrièremogelijkheden vergroot.",

  "support.modules.module7.title": "Praktijkgerichte Projecten en Simulaties",

  "support.modules.module7.body": "Om je optimaal voor te bereiden op de arbeidsmarkt, werk je aan praktijkgerichte projecten waarin je jouw technische vaardigheden toepast. Je lost realistische IT-problemen op in teamverband, waarbij je niet alleen je technische kennis, maar ook je project- en klantmanagementvaardigheden versterkt.",
  ...
  "support.general.hours.value": "Elke dag van 8u30 tot 17u <small>(Lessen starten om 9u)</small>",

  "support.general.location.label": "Locatie",

  "support.general.location.value": "Campus Rouppeplein of Digital City Oudergem <small>Beide locaties zijn zeer goed bereikbaar met het openbaar vervoer.</small>",

  "support.general.accessibility": "<strong>Toegankelijkheid:</strong> Heb je specifieke behoeften of noden om aan te sluiten bij de selecties of opleiding? Bijvoorbeeld omwille van een fysieke beperking. Laat het ons weten.",

  "support.benefits.title": "Voordelen",

  "support.benefits.item1.title": "Vervoerskosten",

  "support.benefits.item1.body": "Tijdens de opleiding worden je vervoerskosten volledig terugbetaald.",

  "support.benefits.item2.title": "Kinderopvang",

  "support.benefits.item2.body": "De kosten voor kinder- of buitenschoolse opvang worden terugbetaald.",

  "support.benefits.item3.title": "Uitkeringen",

  "support.benefits.item3.body": "Tijdens de opleiding blijf je wettelijk in orde met je werkloosheidsvergoeding en andere uitkeringen.",
  ...
  "vacancies.empty": "Er zijn momenteel geen openstaande vacatures. Kom binnenkort terug of volg ons op LinkedIn voor updates.",
  ...
  "team.highlight.lead": "Effectieve teams communiceren open, benutten elkaars sterktes en omarmen diversiteit. Maak kennis met enkele van de gezichten die elke dag het verschil maken.",
  ...
  "team.teamSection.lead": "Een greep uit de vele mensen die INTEC Brussel elke dag mee vormgeven.",
